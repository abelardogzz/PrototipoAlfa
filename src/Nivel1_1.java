 ...
 * @author Abelardo
 */
public class Nivel1_1 extends JFrame implements ActionListener, KeyListener, Runnable {
    ...
    public static void main(String[] args){ 
         ...
         //Crea un nuevo objeto nvlNivel1_1
        Nivel1_1 nvlNivel1_1 = new Nivel1_1();
        //Despliega la ventana en pantalla al hacerla visible
        nvlNivel1_1.setVisible(true);
        
        nvlNivel1_1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        //Despliega la ventana en pantalla al hacerla visible
        nvlNivel1_1.setVisible(true);
        
        //Para que se pueda cerrar la pantalla
        nvlNivel1_1.addWindowListener(new WindowAdapter() {
   ...
   /**
    ...
    // Inicializan el DoubleBuffer
        ...
        URL urlImagenFondo = this.getClass().getResource("recursos/Fondo1.png");
    ...
    public void paint1(Graphics graDibujo) {
        graDibujo.fillRect(0, 0, WIDTH, HEIGHT);
            if (jugJuan != null) {
                    ...
                    for (Alacran alaAlacranes : lklAlacranes) {
                        alaAlacranes.paint(graDibujo, this);
                    }
